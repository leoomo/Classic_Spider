<script lang="ts">
	...
	// ============== 测试功能 ==============
	function testVictoryModal() {
		console.log('[Test] 触发胜利弹窗');
...
<div class="game-container" role="application" oncontextmenu={(e) => e.preventDefault()} onclick={handleBackgroundClick}>
	...
	<header class="toolbar">
		...
		<div class="actions">
			...
			<!-- 测试按钮 -->
			<button class="btn debug-btn" onclick={testVictoryModal} title="测试胜利弹窗">
				🎉
			</button>
			<button class="btn debug-btn" onclick={testLeaderboard} title="测试排行榜">
				🏆
			</button>
		</div>
	</header>
